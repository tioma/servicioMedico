...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr align="center">
    	<td colspan="2" align="center">
    		<form id="frmListado" action="rankingEmpleados.php" method="post">
			<table>
				<tr align="center">
    			...
    			<tr>
			    	<td colspan="4">Seg&uacute;n
    					<select name="sel_orden" id="orden_graf"> 
            				<option value="cant" >Licencias pedidas</option>
                			<option value="dias" >D&iacute;as tomados</option>
            			</select>
    				</td>
    			</tr>
    			<tr>
